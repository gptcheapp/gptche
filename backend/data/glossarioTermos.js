...
//  - rota /glossario (lookup direto, bypassa a API pra esses termos)
//  - rota /chat (via tool `consultar_glossario_gaucho`, pra o bot reconhecer
//    esses termos numa conversa normal sem esperar o usuário abrir o Glossário)
//
// Adicionar um termo novo aqui atualiza as duas experiências ao mesmo tempo.
export const VERBETES_ANCORA = {
  "buenas e me espalho": {
    categoria: "Expressão",
    nivel: "Regional",

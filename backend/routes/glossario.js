...
const VERBETES_ANCORA = {
  ...
  "mate galleta": {
    categoria: "Substantivo",
    nivel: "CTG/Tradicional",
    significado: "Tipo de cuia pequena e arredondada, feita de porongo grosso, usada geralmente para matear sozinho ou em roda pequena. O nome vem da semelhança de formato com a galleta de campo — um pão redondo que dura semanas sem endurecer.",
    exemplo: "Nas viagens curtas eu prefiro o mate galleta, cabe na mão e não esfria.",
    curiosidade: "Não é comida, é a cuia! Tradição compartilhada entre o litoral, a Banda Oriental (Uruguai) e o Pampa gaúcho — existe até uma milonga famosa com esse nome.",
    gptche_diz: "Bah, muita gente pensa que é comida, mas é a cuia mais charmosa da história, tchê!",
  },
  "cuia": {
    categoria: "Substantivo",
    nivel: "Cotidiano",
    significado: "Recipiente tradicional usado para preparar e beber o chimarrão, feito geralmente de porongo (cabaça) ou cuieira. Pode ter vários formatos: gaúcha, coquinho, gajeta/galleta, torpedo, argentina, entre outros.",
    exemplo: "Tu já curtiu a tua cuia nova ou ainda tá dando gosto de mofo?",
    curiosidade: "A cuia de porongo tem 'beiço' (abertura voltada para fora); a de cuieira não tem. Os dois materiais preservam melhor o sabor e a temperatura do que porcelana, vidro ou metal.",
    gptche_diz: "Cuia boa é que nem bota velha, tchê: cada dia fica mais tua.",
  },
  "porongo": {
    categoria: "Substantivo",
    nivel: "CTG/Tradicional",
    significado: "Fruto da planta Lagenaria siceraria (uma cabaça), colhido e curado para virar cuia. É o material mais tradicional e valorizado na cultura do chimarrão.",
    exemplo: "Essa cuia é de porongo legítimo, colhido em janeiro e curado no estaleiro.",
    curiosidade: "A colheita do porongo é feita quando o fruto está maduro, em janeiro. Depois passa por secagem cuidadosa pra não rachar, e só então é raspado e transformado em cuia — um processo quase artesanal que pode levar semanas.",
    gptche_diz: "Porongo bem curado, tchê, vale mais que cuia de loja bonita e sem alma!",
  },
  "tereré": {
    categoria: "Substantivo",
    nivel: "Regional",
    significado: "Bebida preparada com o mesmo procedimento do chimarrão, mas com água gelada em vez de quente. Tradição forte no Paraguai e no Mato Grosso do Sul, também apreciada em dias quentes no RS.",
    exemplo: "Fez baita calor hoje, bora tomar um tereré na sombra?",
    curiosidade: "O nome vem do som do 'ronco' da guampa (cuia) quando a bebida tá terminando. A erva usada costuma ser mais grossa que a do chimarrão, com mais talo — e a água gelada tem mais chance de entupir a bomba.",
    gptche_diz: "No calor, tchê, até o gaúcho mais tradicional troca a água quente pelo gelo do tereré!",
  },
  "chimarrão invertido": {
    categoria: "Expressão",
    nivel: "Regional",
    significado: "Variação de preparo em que a erva-mate fica por cima da água, em vez de misturada dentro da cuia. Resulta num sabor mais suave e numa erva que dura mais tempo sem queimar.",
    exemplo: "Prefiro o chimarrão invertido de manhã, fica mais leve pra começar o dia.",
    curiosidade: "Nessa técnica, a água fica no fundo da cuia e a erva forma uma camada por cima, protegendo-a do calor direto — isso reduz o amargor e prolonga o frescor da erva mate.",
    gptche_diz: "Invertido ou tradicional, tchê, o que importa é que a roda não pare!",
  },
  "mateador": {
    categoria: "Substantivo",
    nivel: "CTG/Tradicional",
    significado: "Pessoa responsável por preparar e servir o chimarrão numa roda, controlando a água, a erva e a ordem de quem bebe.",
    exemplo: "Hoje o mateador da roda é o vô, ninguém prepara um chimarrão como ele.",
  ...
  "surungo": {
    categoria: "Substantivo",
    nivel: "CTG/Tradicional",
    significado: "Baile, bailanta, festança, arrasta-pé — encontro dançante popular, geralmente ao som da gaita.",
    exemplo: "Sábado tem surungo lá no salão do CTG, bora dançar até o gaiteiro cansar!",
    curiosidade: "Imortalizada na música 'Surungo' de João Luiz Correia: 'Num galpão de pau-a-pique, chão batido bem molhado, um surungo bem largado, ao costume missioneiro...' — retrato clássico do baile campeiro.",
    gptche_diz: "Surungo bom, tchê, só acaba quando acaba a erva e a gaita!",
  },
  "xerenga": {
    categoria: "Substantivo",
    nivel: "Regional",
    significado: "Faca de uso diário do gaúcho, geralmente uma faca velha e simples, usada para tarefas do cotidiano como picar fumo — não é arma de ataque ou defesa.",
    exemplo: "Me alcança a xerenga ali que eu preciso picar um fumo pro cigarro de palha.",
    curiosidade: "Palavra de origem africana incorporada ao vocabulário gaúcho. Aparece na música 'Da Estância pra Venda': 'traga sal grosso e sabão pra coceira e uma xerenga pra picar o meu crioulo' (crioulo, aqui, é o fumo).",
    gptche_diz: "Xerenga não é pra brigar, tchê — é ferramenta, não arma!",
  },
  "caborteiro": {
    categoria: "Adjetivo",
    nivel: "Regional",
    significado: "Diz-se do cavalo (ou outro animal) manhoso, arisco, infiel, que não se deixa pegar fácil. Também descreve pessoa esperta, velhaca, matreira, que vive de expedientes.",
    exemplo: "Esse cavalo é meio caborteiro, foge só de ver o cabresto.",
    curiosidade: "Aparece na música 'Coração Caborteiro': 'Meu zaino tem seus limites, na cerca do seu potreiro, no entanto não há limites, pra um coração caborteiro!'",
    gptche_diz: "Coração caborteiro, tchê, é aquele que não respeita cerca nenhuma!",
  },
  "sangari": {
    categoria: "Substantivo",
    nivel: "Regional",
    significado: "Bebida caseira feita com água e açúcar, geralmente com limão, laranja ou vinho tinto — versão gaúcha da sangria espanhola, tradicionalmente servida sem gelo em festas de família.",
    exemplo: "Vó, faz um sangari pra nós, tá um calor dos infernos hoje!",
    curiosidade: "O nome é uma variante regional da palavra espanhola 'sangria', mas a receita muda de cidade pra cidade: em uns lugares é suco de limão ou laranja com água e açúcar, em outros é vinho tinto com água e açúcar. Sinônimo: kisuco.",
    gptche_diz: "Bah, pergunta a receita do sangari pra três gaúchos diferentes que tu ganha três respostas diferentes!",
  },
  "olhar de revesgueio": {
    categoria: "Expressão",
    nivel: "Cotidiano",
    significado: "Olhar atravessado, de lado, desconfiado ou de reprovação.",
    exemplo: "Cheguei atrasado e o chefe me olhou de revesgueio a reunião inteira.",
    curiosidade: "'Revesgueio' vem de 'revés' — olhar torto, na diagonal, que não encara de frente. É puro tom de desconfiança ou reprovação silenciosa.",
    gptche_diz: "Quando o gaúcho olha de revesgueio, tchê, nem precisa falar — já disse tudo!",
  },
  "xaropiar": {
    categoria: "Verbo",
    nivel: "Cotidiano",
    significado: "Encher o saco, tirar a paciência de alguém, insistir de forma chata. Quem faz isso é chamado de 'xarope'.",
    exemplo: "Para de xaropiar e vem me ajudar aqui, tchê!",
    curiosidade: "'Xarope' vem do mesmo radical e descreve a pessoa chata, que vive enchendo o saco dos outros.",
    gptche_diz: "Xarope que se preze não desiste no primeiro não, tchê!",
  },
  "guela": {
    categoria: "Substantivo",
    nivel: "Cotidiano",
    significado: "Garganta, goela. Quem grita ou fala muito alto é chamado de 'gueludo'.",
    exemplo: "Guri, para de gritar com essa guela que dá pra ouvir lá fora!",
    curiosidade: "É comum a mãe gaúcha chamar o filho de 'gueludo' quando ele grita xaropiando por comida.",
    gptche_diz: "Guela boa é a que canta, tchê, não a que só reclama!",
  },
  "lambuja": {
    categoria: "Substantivo",
    nivel: "Regional",
    significado: "Aquilo que se ganha além do combinado — vantagem extra, gratuita e inesperada, tipo um brinde.",
    exemplo: "Comprei um par de botas e o vendedor me deu um cinto de lambuja.",
    curiosidade: "Imortalizada na música 'Guri', um clássico do cancioneiro gaúcho: 'E de lambuja, permita que eu nunca saia daqui.'",
    gptche_diz: "Lambuja é aquele algo a mais que deixa o dia mais tri, tchê!",
  },
  "tunda": {
    categoria: "Substantivo",
    nivel: "Cotidiano",
    significado: "Surra, castigo físico. Hoje usado mais em sentido figurado, como em 'levar uma tunda' numa disputa ou jogo.",
    exemplo: "O Grenal de ontem foi uma tunda só, cinco a um!",

...
PEÇAS PRINCIPAIS DO PEÃO: "bombacha" (calça larga presa na cintura pela guaiaca e no tornozelo por botões — herança da Guerra do Paraguai, 1865, trazida pelos ingleses; estreitas na Serra, largas na Fronteira; cores sóbrias), "chiripá" (vestimenta anterior à bombacha, sem costura, pano passado entre as pernas e preso na cintura; versões: primitivo de couro, chiripá-fralda e chiripá farroupilha), "guaiaca" (cinto largo de couro com bolsinhos para dinheiro e armas — do quíchua "huayaca"), "rastra" (cinto ornamentado de prata ou metal, sem bolsos, de origem platina, usado sobre a guaiaca em ocasiões formais), "bota" (de couro, envolve pé e perna — antigamente "bota de garrão de potro"; nunca branca), "alpargata" (sandália de couro, calçado mais informal), "lenço" (pano de seda no pescoço; cores: vermelho, branco, azul, verde, amarelo, carijó; preto só em luto; tem 8 tipos de nó), "chapéu" (de feltro ou palha com barbicacho; único cobre-cabeça aceito nas diretrizes oficiais do MTG; não se usa em ambiente coberto, exceto em apresentações), "boina" (cobertura de origem basco-castelhana que chegou à região via fronteira com Argentina e Uruguai — não tem relação com a colonização italiana da Serra; muito usada na Fronteira gaúcha, conhecida como "boina castelhana" ou "boina pampeana"; seu uso é vedado nas diretrizes oficiais do MTG para a pilcha de concurso e apresentação, embora seja adotada informalmente por muitos gaúchos, sobretudo no inverno), "colete" (sem mangas e sem gola, abotoado na frente), "faixa" (tira de pano na cintura: vermelha, preta ou bege cru, 10-12 cm), "tirador" (tira de couro que substitui o cinto na cintura, com fivela reforçada — usado tanto a cavalo, prendendo o laço durante a lida, quanto a pé; peça de trabalho do peão que lida com gado), "faca" (acessório da pilcha completa), "galocha" (bota de borracha para dias de chuva e lida no barro).
